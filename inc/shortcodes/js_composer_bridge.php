...
vc_add_param( "vc_row", array(
	...
	"value" => array(
		...
		"Повторить (горизонтально & вертикально)" => "repeat",
		"Повторить по горизонтали" => "repeat-x",
		"Повторите вертикально" => "repeat-y",
	),
	"dependency" => array(
		"element" => "type",
		"value" => array( '1', '2', '3', '4', '5' ),
...
if ( isset( $vc_row_shortcode['params'] ) && is_array( $vc_row_shortcode['params'] ) ) {
	...
	array_unshift( $params, array(
		...
		'value' => array(
			'По умолчанию The7' => '',
			'По умолчанию VC' => 'vc_default',
			'Полоса 1 (от темы вариантов > полосы)' => '1',
			'Полоса 2 (от темы вариантов > полосы)' => '2',
			'Полоса 3 (от темы вариантов > полосы)' => '3',
			'Полоса 4 (темный фон & света содержание)' => '4',
			'Полоса 5 (светлый фон & темное содержание)' => '5',
		),
	) );
...
vc_map( array(
	...
	'params'		=> array(
		...
		array(
			...
			"value"			=> array(
				"Название"					=> "title_like",
				"Лёгкий (50% содержание)"	=> "content_like",
				"Акцент"				=> "accent",
		...
		array(
			...
			"type"			=> "dropdown",
			"value"			=> array(
				"Круговая диаграмма (по умолчанию)"	=> "default",
				"Счетчик"				=> "counter"
			),
			"admin_label"	=> true,
		),
...
vc_add_param("vc_tabs", array(
	...
	"param_name" => "style",
	"value" => array(
		"Стиль 1" => "tab-style-one",
		"Стиль 2" => "tab-style-two",
		"Стиль 3" => "tab-style-three",
		"Стиль 4" => "tab-style-four"
	)
));
...
vc_add_param("vc_progress_bar", array(
	...
	"value" => array(
		'Стиль 1 (текст на панели)' => 'on',
		'Стиль 2 (текст над густой бар)' => 'top',
		'Стиль 3 (текст выше тонкий бар)' => 'thin_top',
	)
));
...
vc_add_param("vc_progress_bar", array(
	...
	"value" => array(
		...
		'Контуры' => 'outline',
		'Полупрозрачная' => 'transparent',
	)
));

// add accent predefined color
$param = WPBMap::getParam('vc_progress_bar', 'bgcolor');
$param['value'] = array( 'Акцент' => 'accent-bg', 'Пользовательские' => 'custom' );
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			"type" => "colorpicker",
			"heading" => "Цвет пользовательского заголовка",
		...
		array(
			"type" => "colorpicker",
			"heading" => "Цвет пользовательского разделителя",
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			"type" => "textfield",
			"heading" => "Ширина элемента (в % или px)",
			"param_name" => "el_width",
			"value" => "100%",
			"description" => ""
		),
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"param_name" => "type",
			"value" => array(
				"Загруженные изображения" => "uploaded_image",
				"Изображение из URL-адреса" => "image",
				"Видео с url" => "video"
			),
			"description" => ""
		),
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"type" => "checkbox",
			"value" => array(
				"Включить закругленные углы" => "true",
			),
			"dependency" => array(
				"element" => "featured_images",
				"value" => array( "true" )
	...
	'params' => array(
		...
		array(
			...
			'value' => array(
				'Классика' => 'classic',
				'По центру' => 'centered',
				'Снизу перекрытия' => 'bottom_overlap',
				'Сторона перекрытия' => 'side_overlap',
			),
			'edit_field_class' => 'vc_col-xs-12 vc_column dt_row-6',
		),
		// -- Classic style.
		...
		array(
			...
			'value' => array(
				'Отключено' => 'disabled',
				'Стандарт' => 'standard',
				'JavaScript страницы' => 'js_pagination',
				'"Загрузить больше" Кнопка' => 'js_more',
				'Бесконечной прокрутки' => 'js_lazy_loading',
			),
			'edit_field_class' => 'vc_col-xs-12 vc_column dt_row-6',
		),
		// -- Disabled.
		...
		array(
			...
			'value' => array(
				'Выкл' => 'off',
				'Выдержка' => 'show_excerpt',
				'Отправить содержание' => 'show_content',
			),
			'edit_field_class' => 'vc_col-xs-12 vc_column dt_row-6',
			'group' => __( 'Post', 'the7mk2' ),
		),
		...
		array(
			...
			'value' => array(
				'Выкл' => 'off',
				'По умолчанию ссылка' => 'default_link',
				'Кнопка по умолчанию' => 'default_button',
			),
			'edit_field_class' => 'vc_col-xs-12 vc_column dt_row-6',
			'group' => __( 'Post', 'the7mk2' ),
		),
...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			'value' => array(
				'Классика' => 'classic',
				'Перекрытие дна (фон)' => 'bottom_overlap',
				'Снизу перекрытия (градиент)' => 'gradient_overlap',
				'Наложение (фон)' => 'gradient_overlay',
				'Наложение (градиент)' => 'gradient_rollover',
			),
			'edit_field_class' => 'vc_col-xs-12 vc_column dt_row-6',
		),
		...
		array(
			...
			'std' => 'resize',
			'value' => array(
				'Сохранять пропорции изображения' => 'proportional',
		...
		array(
			...
			'type' => 'dropdown',
			'value' => array(
				'На основе ширины браузера' => 'browser_width_based',
				'Пост на основе ширины' => 'post_width_based',
			),
			'edit_field_class' => 'vc_col-xs-12 vc_column dt_row-6',
		),
		// -- Browser width based.
		...
		array(
			...
			'type' => 'dropdown',
			'value' => array(
				'Нет (большой пост заполняет 2 col.)' => 'n',
				'Да (широкий пост заполняет 1 коль.)' => 'y',
			),
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"type" => "checkbox",
			"value" => array(
				"Показать фильтр категорий" => "true",
			),
		),
		array(
			...
			"type" => "checkbox",
			"value" => array(
				"Показать имя / Дата возрастанияВg" => "true",
			),
		),
		array(
			...
			"type" => "checkbox",
			"value" => array(
				"Показать asc. / по убыванию. порядок" => "true",
			),
		),
		// Appearance group.
		array(
		...
		array(
			...
			"type" => "dropdown",
			"value" => array(
				"Сохранить исходную ширину" => "false",
				"Сделать сообщения одинаковой ширины" => "true",
			),
			"edit_field_class" => "vc_col-xs-12 vc_column dt_row-6",
		),
		array(
		...
		array(
			...
			"value" => array(
				"Без фона" => "disabled",
				"Полноширинные изображение" => "fullwidth",
				"Изображение с прокладки безасбестовые" => "with_paddings"
			),
			"edit_field_class" => "vc_col-xs-12 vc_column dt_row-6",
		),
		array(
		...
		array(
			...
			"type" => "checkbox",
			"value" => array(
				'Показать "Подробнее" кнопки' => "true",
			),
		),
		array(
			"group" => __("Appearance", 'the7mk2'),
		...
		array(
			...
			"type" => "checkbox",
			"value" => array(
				"Показать сообщение категории" => "true",
			),
		),
		array(
			"group" => __("Post Meta", 'the7mk2'),
		...
		array(
			...
			"type" => "checkbox",
			"value" => array(
				"Показать сообщение автора" => "true",
			),
		),
		array(
			"group" => __("Post Meta", 'the7mk2'),
			...
			"type" => "checkbox",
			"value" => array(
				"Показать комментарии к сообщению" => "true",
			),
		),
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"value" => array(
				'Включено (изображение с отступами)' => 'with_paddings',
				'Включено (изображение без отступов)' => 'fullwidth',
				'Отключено' => 'disabled'
			),
			"edit_field_class" => "vc_col-xs-12 vc_column dt_row-6",
		),
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"param_name" => "style",
			"value" => array(
				"Медиа полной ширины" => "1",
				"Медиа с заполнения & наброски" => "2",
				"Media с обивка & Заливка фона" => "3"
			),
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"param_name"	=> "style",
			"value"			=> array(
				"По умолчанию (параметры темы / кнопки)"	=> "default",
				"Ссылка"										=> "link",
				"Свет"										=> "light",
				"Свет с фоном при наведении"			=> "light_with_bg",
				"Контур"									=> "outline",
				"Контур с фона при наведении курсора"			=> "outline_with_bg",
			)
		),
...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			"value" => array(
				"Вертикальный" => "horizontal",
				"Горизонтальные" => "vertical"
			),
			"description" => ""
		),
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"type" => "dropdown",
			"value" => array(
				"Изменить положение стрелки" => "reposition-arrows",
				"Оставить как есть" => "no-changes",
				"Скрыть стрелки" => "hide-arrows",
			),
			'dependency'	=> array(
				'element'	=> 'arrows',
				'value'		=> 'y',
		...
		array(
			...
			"type" => "dropdown",
			"value" => array(
				"МАЛЕНЬКАЯ ТОЧКА НАЖАТИЯ" => "small-dot-stroke",
